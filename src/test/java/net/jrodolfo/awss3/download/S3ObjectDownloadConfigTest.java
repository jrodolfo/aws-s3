...
public class S3ObjectDownloadConfigTest {

    @Test
    public void resolveConfigUsesDefaultsForOptionalValues() {
        S3ObjectDownload.Config config = S3ObjectDownload.resolveConfig(new String[]{"bucket-a", "hello.txt"});
    ...
    public void resolveConfigUsesExplicitOptionalArguments() {
        S3ObjectDownload.Config config = S3ObjectDownload.resolveConfig(
