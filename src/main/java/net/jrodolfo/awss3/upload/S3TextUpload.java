...
public class S3TextUpload {
    ...
    public static void main(String[] args) {
        try {
            ...
            try (S3Client s3 = S3Client.builder().region(config.region).build()) {
            ...
            fail("S3 request failed. " + awsMessage(e)
                    + " Check the bucket name, region, object key, and your permissions.");
